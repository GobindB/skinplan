...
export const AppStoreSection = () => {
  ...
  return (
    <>
      ...
      <section id="app-store" className="relative py-20 bg-gradient-to-b from-[#FFE4D6] via-[#FFF1E6] to-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-start">
            {/* Left Column - Content */}
            <div className="flex-1 text-center lg:text-left max-w-xl mx-auto lg:mx-0">
              {/* Beta Tag */}
              <div className="inline-flex items-center gap-3 px-3 py-1.5 rounded-full bg-[#E8D5C8]/30 border border-[#E8C5B0] mb-8">
                <div className="flex items-center gap-2">
                  <div className="w-2 h-2 rounded-full bg-[#E8855B] animate-pulse" />
                  <div className="flex items-center -space-x-1.5">
                    {betaUsers.map((user, index) => (
                      <div key={index} className="relative w-5 h-5 rounded-full border-2 border-[#FFF1E6] overflow-hidden">
                        <Image
                          src={user.image}
                          alt=""
                          fill
                  ...
                  <span className="text-sm font-medium text-[#5C3D2E] whitespace-nowrap">
