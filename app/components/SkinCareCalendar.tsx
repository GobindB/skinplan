...
export default function SkinCareCalendar() {
  ...
  return (
    <div className="w-full max-w-[375px] mx-auto bg-[#FAF3EB] text-[#2C1810] flex flex-col h-[700px] relative">
      {/* Header with Tabs - Fixed at top */}
      <div className="bg-[#2C1810] sticky top-0 z-10 flex-none rounded-b-3xl shadow-lg">
        <div className="px-4 pt-6 pb-4">
          <div className="flex flex-col items-center">
            <h1 className="text-xl font-medium text-[#FAF3EB]">Your Skincare Journey</h1>
            <p className="text-sm text-[#E8C5B0] mt-1">In your pocket</p>
            {/* Interactive Demo Badge */}
            <div className="mt-3 inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#8B4513]/10 border border-[#8B4513]/20">
              <div className="w-1.5 h-1.5 rounded-full bg-[#E8855B] animate-pulse" />
              <span className="text-xs text-[#E8855B] font-medium">Interactive Preview</span>
            </div>
          </div>
        </div>
      ...
      <div className="flex-1 overflow-y-auto overscroll-y-contain px-4 pt-6 pb-24">
        {state.view === 'calendar' && (
      ...
      <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-[#FAF3EB] via-[#FAF3EB] to-transparent">
        <motion.button 
          onClick={() => updateState({ showCreatePlan: true })}
          whileHover={{ scale: 1.02 }}
          whileTap={{ scale: 0.98 }}
          className="w-full py-4 px-6 rounded-2xl bg-[#2C1810] text-white text-lg font-medium tracking-tight shadow-lg border border-[#E8C5B0]/20 transition-all duration-300"
        >
